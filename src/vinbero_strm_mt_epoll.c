...
vinbero_iface_MODULE_init(struct vinbero_com_Module* module) {
    ...
    int out;
    vinbero_com_Config_getInt(module->config, module, "vinbero_tcp_mt_epoll.clientTimeoutSeconds", &out, 3);
    localModule->clientTimeout.it_value.tv_sec = out;
    vinbero_com_Config_getInt(module->config, module, "vinbero_tcp_mt_epoll.clientTimeoutSeconds", &out, 3);
    localModule->clientTimeout.it_interval.tv_sec = out;
    vinbero_com_Config_getInt(module->config, module, "vinbero_tcp_mt_epoll.clientTimeoutNanoSeconds", &out, 0);
...
/*
    GENC_TREE_NODE_FOR_EACH_CHILD(module, index) {
        ...
        struct vinbero_tcp_mt_epoll_iface childiface;
...
vinbero_iface_TLOCAL_init(struct vinbero_com_TlModule* tlModule) {
    ...
    vinbero_com_Config_getInt(tlModule->module->config, tlModule->module, "vinbero_tcp_mt_epoll.workerMaxClients", &workerMaxClients, 1024);
...
static int
vinbero_tcp_mt_epoll_loadChildClModules(struct vinbero_com_ClModule* clModule) {
    int ret;
...
static int
vinbero_tcp_mt_epoll_initChildClModules(struct vinbero_com_ClModule* clModule) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    GENC_TREE_NODE_FOR_EACH_CHILD(clModule, index) {
        ...
        if(ret < VINBERO_COM_STATUS_SUCCESS)
            return ret;
        if(vinbero_tcp_mt_epoll_initChildClModules(childClModule) < VINBERO_COM_STATUS_SUCCESS)
            return ret;
    }
    return VINBERO_COM_STATUS_SUCCESS;
}
...
static int
vinbero_tcp_mt_epoll_rInitChildClModules(struct vinbero_com_ClModule* clModule) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    GENC_TREE_NODE_FOR_EACH_CHILD(clModule, index) {
        struct vinbero_com_ClModule* childClModule = GENC_TREE_NODE_GET_CHILD(clModule, index);
...
static int
vinbero_tcp_mt_epoll_destroyChildClModules(struct vinbero_com_ClModule* clModule) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    GENC_TREE_NODE_FOR_EACH_CHILD(clModule, index) {
        struct vinbero_com_ClModule* childClModule = GENC_TREE_NODE_GET_CHILD(clModule, index);
...
static int
vinbero_tcp_mt_epoll_rDestroyChildClModules(struct vinbero_com_ClModule* clModule) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    GENC_TREE_NODE_FOR_EACH_CHILD(clModule, index) {
        struct vinbero_com_ClModule* childClModule = GENC_TREE_NODE_GET_CHILD(clModule, index);
...
static void
vinbero_tcp_mt_epoll_handleConnection(struct vinbero_com_TlModule* tlModule, int epollFd, int* serverSocket) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    ...
    if((ret = vinbero_tcp_mt_epoll_loadChildClModules(localTlModule->clModuleArray[clientSocket])) < VINBERO_COM_STATUS_SUCCESS) {
        VINBERO_COM_LOG_ERROR("vinbero_tcp_mt_epoll_loadChildClModules() failed");
    ...
    if((ret = vinbero_tcp_mt_epoll_initChildClModules(localTlModule->clModuleArray[clientSocket])) < VINBERO_COM_STATUS_SUCCESS) {
        VINBERO_COM_LOG_ERROR("vinbero_tcp_mt_epoll_initChildClModules() failed");
        vinbero_tcp_mt_epoll_destroyChildClModules(localTlModule->clModuleArray[clientSocket]); // what if this also failed? (FATAL)
        free(localTlModule->clModuleArray[clientSocket]);
        close(clientSocket);
        close(localTlModule->clientTimerFdArray[clientSocket]);
...
static int
vinbero_tcp_mt_epoll_handleRequest(struct vinbero_com_TlModule* tlModule, int* serverSocket, int clientSocket) {
    VINBERO_COM_LOG_TRACE2();
    struct vinbero_tcp_mt_epoll_Module* localModule = tlModule->module->localModule.pointer;
    struct vinbero_tcp_mt_epoll_TlModule* localTlModule = tlModule->localTlModule.pointer;
    int ret;
...
static void
vinbero_tcp_mt_epoll_handleDisconnection(struct vinbero_com_TlModule* tlModule, int* serverSocket, int clientSocket) {
    VINBERO_COM_LOG_TRACE2();
    struct vinbero_tcp_mt_epoll_TlModule* localTlModule = tlModule->localTlModule.pointer;
    vinbero_tcp_mt_epoll_destroyChildClModules(localTlModule->clModuleArray[clientSocket]);
    free(localTlModule->clModuleArray[clientSocket]);
...
static int
vinbero_tcp_mt_epoll_handleError(struct vinbero_com_TlModule* tlModule, int* serverSocket, int clientSocket) {
    VINBERO_COM_LOG_TRACE2();
    struct vinbero_tcp_mt_epoll_TlModule* localTlModule = tlModule->localTlModule.pointer;
...
static int
vinbero_tcp_mt_epoll_handleTimeout(struct vinbero_com_TlModule* tlModule, int* serverSocket, int timerFd) {
    VINBERO_COM_LOG_TRACE2();
    int ret;
    struct vinbero_tcp_mt_epoll_TlModule* localTlModule = tlModule->localTlModule.pointer;
...
static void
vinbero_tcp_mt_epoll_handleUnexpected(struct vinbero_com_TlModule* tlModule, int* serverSocket, int fd) {
    VINBERO_COM_LOG_TRACE2();
    struct vinbero_tcp_mt_epoll_TlModule* localTlModule = tlModule->localTlModule.pointer;
