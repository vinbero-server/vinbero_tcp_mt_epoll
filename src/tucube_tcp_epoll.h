...
struct tucube_tcp_epoll_Module {
    int (*tucube_tcp_epoll_Module_init)(struct tucube_Module_Config*, struct tucube_Module_List*);
    int (*tucube_tcp_epoll_Module_tlInit)(struct tucube_Module*, struct tucube_Module_Config*);
